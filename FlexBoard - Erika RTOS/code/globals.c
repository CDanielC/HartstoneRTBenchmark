...
const uint16_t initKWPP[N_TASK + MAX_NEWTASKS] = { T1_KWPP, T2_KWPP, T3_KWPP, T4_KWPP, T5_KWPP,
												   ...
												   T3_KWPP, T3_KWPP, T3_KWPP, T3_KWPP, T3_KWPP,
												   T3_KWPP, T3_KWPP, T3_KWPP, T3_KWPP};

const float initFreq[N_TASK + MAX_NEWTASKS] = { T1_FREQ, T2_FREQ, T3_FREQ, T4_FREQ, T5_FREQ,
												   T3_FREQ, T3_FREQ, T3_FREQ, T3_FREQ, T3_FREQ,
												   T3_FREQ, T3_FREQ, T3_FREQ, T3_FREQ, T3_FREQ,
												   T3_FREQ, T3_FREQ, T3_FREQ, T3_FREQ};

const AlarmType initAlarms[N_TASK + MAX_NEWTASKS] = { AlarmTask1, AlarmTask2, AlarmTask3,
		AlarmTask4, AlarmTask5, AlarmTaskA1, AlarmTaskA2, AlarmTaskA3, AlarmTaskA4, AlarmTaskA5,
		AlarmTaskA6, AlarmTaskA7, AlarmTaskA8, AlarmTaskA9, AlarmTaskA10, AlarmTaskA11,
		AlarmTaskA12, AlarmTaskA13, AlarmTaskA14};
...
void	initState(float max_util, const AlarmType *alarms, const float *initFreq, const uint16_t *initKWPP)
{
	...
	resetStats(taskSet, N_TASK + MAX_NEWTASKS);
}
